...
export const SEO_CONFIGS = {
  home: {
    title:
      'Skyler Long Portfolio - Full Stack Developer | React, Java, Spring Boot',
    description:
  ...
  about: {
    title: 'About Me - Skyler Long Portfolio | Full Stack Developer',
    description:
  ...
  projects: {
    title: 'Projects - Skyler Long Portfolio | Web Development Showcase',
    description:
  ...
  resume: {
    title: 'Resume - Skyler Long Portfolio | Full Stack Developer CV',
    description:
  ...
  contact: {
    title: 'Contact - Skyler Long Portfolio | Get In Touch',
    description:
