        ...
        <div className="container mx-auto px-6 py-16">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
              Looking for a reliable, highly technical expert for your project?
                  ...
                  {socialLinks.map((social, index) => {
                    ...
                    return (
                      <motion.a
                        ...
                        whileTap={{ scale: 0.95 }}
                        className={`w-16 h-16 rounded-xl bg-white/10 flex items-center justify-center text-gray-100 hover:text-white transition-all duration-200 hover:bg-white/20 ${social.color}`}
                      >
